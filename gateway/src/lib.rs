//! `smug-gateway` is the Rust implementation of **Simple Multiplexer Gateway**.
//!
//! The gateway is a long-running HTTP service that micro-batches incoming requests per route for a
